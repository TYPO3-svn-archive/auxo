...
class tx_auxo_models_people extends tx_auxo_modelbase {	
		/** tablename **/
		public static $table = 'tx_auxo_people';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/auxo/class.tx_auxo_models_people.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/auxo/class.tx_auxo_models_people.php']);
}
?>	