...
class tx_auxo_models_group extends tx_auxo_modelbase {
	/** tablename **/
	static public $table = 'tx_auxo_group';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/auxo/class.tx_auxo_models_groups.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/auxo/class.tx_auxo_models_groups.php']);
}
?>