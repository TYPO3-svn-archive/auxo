...
class tx_auxo_models_project extends tx_auxo_modelbase {	
		/** tablename **/
		static public $table = 'tx_auxo_project';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/auxo/class.tx_auxo_models_project.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/auxo/class.tx_auxo_models_project.php']);
}
?>	