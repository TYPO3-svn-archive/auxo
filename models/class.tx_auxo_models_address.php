...
class tx_auxo_models_address extends tx_auxo_modelbase {	
		/** tablename **/
		public static $table = 'tx_auxo_address';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/auxo/class.tx_auxo_models_address.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/auxo/class.tx_auxo_models_address.php']);
}
?>	